    ...
    <body>
        ...
        <div class="bg-img">
            <div class="content">
                ...
                <form method="POST" id="hlogin" action="Register">
                    <div class="field">
                        <input type="text" style="padding:10px;" name="hid" placeholder="Username">
                    </div>
                    <div class="field space">
                        <input type="password" class="pass-key" name="hpwd" style="padding:10px;" placeholder="Password">
                        <!--            <span class="show">SHOW</span>-->
                    </div>
                    <div class="pass">
                        <a href="HODForgotpassword.jsp">Forgot Password?</a>
                    </div>
                    <div class="field">
                        <input type="submit" name="hlogin"  value="LOGIN">
                    </div><br><br>
                    Don't have account?<a href="hregister.jsp">&nbsp Sign up </a>
                </form>
                <div class="login">
                </div>
            </div>
