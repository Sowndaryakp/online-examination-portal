<%-- 
    Document   : HODPasswordUpdate
    Created on : Jul 18, 2021, 7:25:39 PM
...
<html>
    <head>
        ...
        <title>HOD Password Update</title>
    ...
    <body>
        ...
        <div class="container" >
            ...
            <%if (session.getAttribute("npuname") != null || session.getAttribute("hid") != null) {%>
            <form id="newpass" method="post" action="Register">
                ...
                <center> <span style="font-size: 29px;font-weight: bold;">Enter Your Password</span>
                    ...
                    <div class="form-group">
                        <div  style="width:100%">
                            <input type="submit" name="HODPasswordUpdate" value="Submit" >
                        </div>
                    </div> </center>
<!--                    </div>-->
            </form>  
