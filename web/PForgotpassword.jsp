<%-- 
    Document   : PForgotpassword
    Created on : Jul 18, 2021, 12:15:22 PM
        ...
        <div class="container">
            <form id="forgot" method="post" action="Register">
                ...
                <div class="form-group">
                    <div>
                        <input id="email" class="form-control" style="width:70%" type="text" placeholder="Email" name="pemail" autofocus>
                    </div>
                </div>
                
                <div class="form-group">
                    <div  style="width:100%">
                        <input type="submit" name="Pforgotpassword" value="Submit" >
                    </div>
                </div> 
            </form>  
        </div>
