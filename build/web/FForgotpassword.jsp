<%-- 
    Document   : FForgotpassword
    Created on : Jul 18, 2021, 11:30:52 AM
        ...
        <div class="container">
            <form id="forgot" method="post" action="Register">
                ...
                <div class="form-group">
                    <div>
                        <input id="email" class="form-control" style="width:70%" type="text" placeholder="Email" name="femail" autofocus>
                    </div>
                </div>
                
                <div class="form-group">
                    <div  style="width:100%">
                        <input type="submit" name="fforgotpassword" value="Submit" >
                    </div>
                </div> 
            </form>  
        </div>
