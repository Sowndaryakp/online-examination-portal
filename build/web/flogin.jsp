 ...
 <body>
    ...
    <div class="bg-img">
      <div class="content">
        ...
        <form method="POST" id="flogin" action="Register">
          <div class="field">
            <input type="text" style="padding:10px;" name="fid" placeholder="Username">
          </div>
          <div class="field space">
            <input type="password" class="pass-key" style="padding:10px;" name="fpwd" placeholder="Password">
<!--            <span class="show">SHOW</span>-->
          </div>
          <div class="pass">
            <a href="FForgotpassword.jsp">Forgot Password?</a>
          </div>
          <div class="field">
            <input type="submit" name="flogin" value="LOGIN">
          </div><br><br>
          Don't have account?<a href="fregister.jsp">&nbsp Sign up </a>
</form>
<div class="login">
</div>
</div>
