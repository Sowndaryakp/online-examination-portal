    ...
    <body>
        ...
        <div class="bg-img">
            <div class="content">
                ...
                <form method="POST" id="slogin" action="Register">
                    <div class="field">
                        <input type="text" style="padding:10px;" name="sid" placeholder="Enter your USN">
                    </div>
                    <div class="field space">
                        <input type="password" class="pass-key" style="padding:10px;" name="spwd" placeholder="Enter your Password">
                    ...
                    Don't have account?<a href="sregister.jsp">&nbsp Sign up </a>
                </form>
                <div class="login">
                </div>
            </div>
