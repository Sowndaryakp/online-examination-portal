    ...
    <body>
        ...
        <div class="bg-img">
            <div class="content">
                ...
                <%}%>
                <header>PRINCIPAL LOGIN</header>
                <form method="POST" id="plogin" action="Register">
                    <div class="field">
                        <input type="text" name="pid" style="padding:10px;" placeholder="Username">
                    </div>
                    <div class="field space">
                        <input type="password" name="ppwd" class="pass-key" style="padding:10px;" placeholder="Password">
                        <span class="show">SHOW</span>
                    </div>
                    <div class="pass">
                        <a href="PForgotpassword.jsp">Forgot Password?</a>
                    </div>
                    <div class="field">
                        <input type="submit" name="plogin" value="LOGIN">
                    </div><br><br>
                    Don't have account?<a href="pregister.jsp">&nbsp Sign up </a>
                </form>
                <div class="login">
                </div>
            </div>
